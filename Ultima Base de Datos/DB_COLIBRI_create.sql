...
-- Script generado automaticamente - crear la base desde cero
-- Collation: Modern_Spanish_CI_AI
-- Generado: 2026-08-03 21:27:24
-- ======================================================================

IF DB_ID('COLIBRI') IS NULL
BEGIN
    CREATE DATABASE [COLIBRI] COLLATE Modern_Spanish_CI_AI;
END
GO
...
CREATE TABLE [dbo].[Usuarios] (
    ...
    [fecha_aviso_password] DATETIME2 NULL,
    [ultimo_cambio_password_ip] NVARCHAR(50) NULL,
    [ultimo_cambio_password_dispositivo] NVARCHAR(500) NULL,
...
CREATE TABLE [dbo].[Sesiones] (
    ...
    [fecha_hora_ultima_act] DATETIME2 NOT NULL,
    [fecha_hora_cierre] DATETIME2 NULL,
    [dispositivo_acceso] NVARCHAR(500) NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_PH_usuario_fecha' AND object_id = OBJECT_ID('PasswordHistorial'))
    CREATE NONCLUSTERED INDEX [IX_PH_usuario_fecha] ON [dbo].[PasswordHistorial] ([id_usuario], [fecha_cambio] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BitRR_fecha' AND object_id = OBJECT_ID('Bitacora_Usuarios_RRHH'))
    CREATE NONCLUSTERED INDEX [IX_BitRR_fecha] ON [dbo].[Bitacora_Usuarios_RRHH] ([fecha_hora] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BitPed_pedido' AND object_id = OBJECT_ID('Bitacora_Pedidos'))
    CREATE NONCLUSTERED INDEX [IX_BitPed_pedido] ON [dbo].[Bitacora_Pedidos] ([fecha_hora] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BitInv_fecha' AND object_id = OBJECT_ID('Bitacora_Inventario'))
    CREATE NONCLUSTERED INDEX [IX_BitInv_fecha] ON [dbo].[Bitacora_Inventario] ([fecha_hora] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE name = 'CK_BitFin_accion')
    ALTER TABLE [dbo].[Bitacora_Financiera] ADD CONSTRAINT [CK_BitFin_accion] CHECK ([accion]='ANULACION' OR [accion]='DELETE' OR [accion]='UPDATE' OR [accion]='INSERT');
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BitFin_fecha' AND object_id = OBJECT_ID('Bitacora_Financiera'))
    CREATE NONCLUSTERED INDEX [IX_BitFin_fecha] ON [dbo].[Bitacora_Financiera] ([fecha_hora] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BitAcc_usuario' AND object_id = OBJECT_ID('Bitacora_Acceso'))
    CREATE NONCLUSTERED INDEX [IX_BitAcc_usuario] ON [dbo].[Bitacora_Acceso] ([id_usuario], [fecha_hora] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Turnos_fecha' AND object_id = OBJECT_ID('Turnos_Trabajo'))
    CREATE NONCLUSTERED INDEX [IX_Turnos_fecha] ON [dbo].[Turnos_Trabajo] ([fecha_turno] DESC);
GO
...
CREATE TABLE [dbo].[Pedidos] (
    ...
    [estado] BIT NOT NULL,
    [fecha_hora_entrega] DATETIME2 NULL,
    [fecha_hora_finalizacion] DATETIME2 NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE name = 'CK_Ped_tipo')
    ALTER TABLE [dbo].[Pedidos] ADD CONSTRAINT [CK_Ped_tipo] CHECK ([tipo_servicio]='Para llevar' OR [tipo_servicio]='Salon' OR [tipo_servicio]='mesa' OR [tipo_servicio]='para_llevar' OR [tipo_servicio]='delivery');
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Pedidos_fecha' AND object_id = OBJECT_ID('Pedidos'))
    CREATE NONCLUSTERED INDEX [IX_Pedidos_fecha] ON [dbo].[Pedidos] ([fecha_hora] DESC);
GO
...
CREATE TABLE [dbo].[Historial_Estados_Pedido] (
    ...
    [fecha_hora_cambio] DATETIME2 NOT NULL,
    [detalle] NVARCHAR(500) NULL,
    [estado] BIT NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Cierres_fecha' AND object_id = OBJECT_ID('Cierres_Caja'))
    CREATE NONCLUSTERED INDEX [IX_Cierres_fecha] ON [dbo].[Cierres_Caja] ([fecha_cierre] DESC);
GO
...
CREATE TABLE [dbo].[Asistencia] (
    ...
    [id_empleado] INT NOT NULL,
    [id_turno] INT NULL,
    [fecha_hora_entrada] DATETIME2 NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Asistencia_empleado' AND object_id = OBJECT_ID('Asistencia'))
    CREATE NONCLUSTERED INDEX [IX_Asistencia_empleado] ON [dbo].[Asistencia] ([id_empleado], [fecha_hora_entrada] DESC);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE name = 'CK_Ven_tipo')
    ALTER TABLE [dbo].[Ventas] ADD CONSTRAINT [CK_Ven_tipo] CHECK ([tipo_venta]='descuento' OR [tipo_venta]='cortesia' OR [tipo_venta]='normal');
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE name = 'CK_Ven_estado_v')
    ALTER TABLE [dbo].[Ventas] ADD CONSTRAINT [CK_Ven_estado_v] CHECK ([estado_venta]='pendiente' OR [estado_venta]='anulada' OR [estado_venta]='completada');
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Ventas_fecha' AND object_id = OBJECT_ID('Ventas'))
    CREATE NONCLUSTERED INDEX [IX_Ventas_fecha] ON [dbo].[Ventas] ([fecha_hora] DESC);
GO
